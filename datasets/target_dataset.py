...
class TargetDataset(Dataset):
    ...
    def __init__(self, ZP_target_latent, ZP_img_tensor, ZP_img_tensor_256, ZP_img_clip_tensor):
    ...
    def __getitem__(self, index):
        ...
        return ZP_target_latent, ZP_img_tensor, ZP_img_tensor_256, ZP_img_clip_tensor
