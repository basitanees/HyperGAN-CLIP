...
import torchvision
from models.DynaGAN_ffhq_2 import DynaGAN
...
def train(args, output_dir):
    ...
    indices = torch.ones(args.n_sample)
    indices[-1] = 0
    ...
    for i in pbar:
        ...
        if i ==0:
            wandb.init(project="CLIP2StyleGAN-Cats",config=config)
        ...
        if use_disc:
            ...
            lossG = discr(fake2, c=fake_embed, for_G=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lambda_contrast", type=float, default=1.5, help="Weight of contrastive loss")
    parser.add_argument("--lambda_id", type=float, default=0.02, help="Weight of identity loss") # 3.0
    ...
    args.embed_scaling = None#{"type": "dot"}# None #{"type": "dot"} #None
    # args.iter = 20000
    # args.batch = 2
    # args.embed_scaling = None
