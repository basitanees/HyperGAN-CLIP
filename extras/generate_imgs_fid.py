...
from models.DynaGAN_v1 import SG2Generator
import torchvision
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default="output_disc_one_hott/checkpoint/final.pt")
    ...
    parser.add_argument('--output_imgs_dir', type=str, default="/kuacc/users/aanees20/Dynagan_eval_data/generated_origggg")
